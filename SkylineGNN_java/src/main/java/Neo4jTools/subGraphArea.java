...
public class subGraphArea {
    ...
    String source_db_name = ParsedOptions.db_name;
    String output_folder = ParsedOptions.output_graphInfo_folder;
...
//            sga.EdgesPath = sga.output_folder + "/SegInfo_" + sga.numberofK + "K_" + i + ".txt";
//            sga.NodePath = sga.output_folder + "/NodeInfo_" + sga.numberofK + "K_" + i + ".txt";
//            sga.selectSubGraph();
//            System.out.println("========================================================================================================");
//        }
        subGraphArea sga = new subGraphArea();
        sga.EdgesPath = sga.output_folder + "/SegInfo_" + sga.numberofK + "K" + ".txt";
        sga.NodePath = sga.output_folder + "/NodeInfo_" + sga.numberofK + "K" + ".txt";
        sga.selectSubGraph();
        System.out.println("========================================================================================================");
...
//        int target_graph_size = numberofK;
