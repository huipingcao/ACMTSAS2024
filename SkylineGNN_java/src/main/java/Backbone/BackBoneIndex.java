...
//        this.index_files_folder = ParsedOptions.indexFolder + "/" + db_name;
        this.index_files_folder = ParsedOptions.indexFolder;
        System.out.println("index_files_folder " + this.index_files_folder);
...
//        File highest_folder = new File(index_files_folder + "/level" + this.index_level);
        File highest_folder = new File(index_files_folder + "/level0");
...
//        }
    ...
    private int getlevel() {
        ...
        for (File f : index_dir.listFiles(new levelFileNameFilter())) {
            ...
            System.out.println("BackBoneIndex -- getlevel() -- fname " + fname);
//            int c_level = Integer.parseInt(fname.substring(fname.indexOf("level") + 5));
//            int c_level = Integer.parseInt(fname.substring(fname.indexOf("level")));
//            if (c_level > level) {
//                level = c_level;
//            }
        }
