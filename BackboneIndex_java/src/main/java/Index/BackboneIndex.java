...
//                System.out.println("    >>>>   removed the created index folder: " + utilities.DirectoriesOperations.removeDirectories(last_index_folder));
//                System.out.println("    >>>>   removed the DB folder folder: " + utilities.DirectoriesOperations.removeDirectories(sub_db_name));
//                System.out.println("    >>>>   clean the index folder: " + utilities.DirectoriesOperations.cleanDirectories(last_index_folder));
                deleted = false;
            }
...
//
                    ...
                    if (neo4j.getNumberofEdges() == neo4j.getNumberofNodes()) {
                        tx.success();
                        break;
                    }
        ...
        System.out.println("Finished segment process !!!!!!!" + updated_node_list.size());
        return updated_node_list;
    }
