...
public class DTWComparison {
    ...
    String datetime = "20201027_182602";
    ...
    public void comparision() {
        ...
        for (File log_file : result_folder.listFiles(new ResultLogFileFilter(bbs_result_prefix))) {
...
//
//
//            String b_path = results_path + "/" + bbs_result_prefix + source + "_" + destination + "_" + timestamp + ".log";
//            int n_hops = getNumberHops(b_path);
//            File performace_log_file = findPerformanceLogFile(date, time);
//
//            long rt = getrunningtime(performace_log_file, source, destination);
//
//            if (rt == 9999999) {
//                continue;
//            }
//
//            if (0 <= n_hops && n_hops < 50 && query_dist[0] != 2) {
//                Pair<String, String> query = new MutablePair<>(source, destination);
//                queries.add(query);
//                query_dist[0] += 1;
//            } else if (50 <= n_hops && n_hops < 100 && query_dist[1] != 3) {
//                Pair<String, String> query = new MutablePair<>(source, destination);
//                queries.add(query);
//                query_dist[1] += 1;
//            } else if (100 <= n_hops && query_dist[2] != 5) {
//                Pair<String, String> query = new MutablePair<>(source, destination);
//                queries.add(query);
//                query_dist[2] += 1;
////            } else if (150 <= n_hops && query_dist[2] != 2) {
////                Pair<String, String> query = new MutablePair<>(source, destination);
////                queries.add(query);
////                query_dist[2] += 1;
//            }

//            System.out.println(timestamp + "   " + source + "->" + destination+"  "+getNumberHops(b_path));
        }

//        System.out.println(queries.size());
//
//        for (Pair<String, String> q : queries) {
//            String b_path = results_path + "/" + bbs_result_prefix + q.getKey() + "_" + q.getValue() + "_" + timestamp + ".log";
//            int n_hops = getNumberHops(b_path);
//            File performace_log_file = findPerformanceLogFile(date, time);
//
//            long rt = getrunningtime(performace_log_file, q.getKey(), q.getValue());
//
//            System.out.println(q.getKey() + " " + q.getValue() + " " + n_hops + " " + rt);
//        }
//        System.exit(0);
...
//        File log_file = new File("/home/gqxwolf/mydata/projectData/BackBone/logs/compareBBSBackbone_C9_NY_15K_100-[2020-12-02~10-44-06].log");
...
//            System.out.println("====================================================");
            String bbs_methods_log_file_path = results_path + "/" + bbs_result_prefix + source + "_" + destination + "_" + timestamp + ".log";
...
//                    System.out.println(src + "," + dest+"  "+bbs_running_time);
