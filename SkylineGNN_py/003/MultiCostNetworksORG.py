...
class MultiCostNetworksORG(InMemoryDataset):
    def __init__(self, dataset, train_paths_folder, root, transform=None, pre_transform=None):
        self.data = dataset
        self.train_paths_folder = train_paths_folder
        super(MultiCostNetworksORG, self).__init__(root, transform, pre_transform)
        index = 0
